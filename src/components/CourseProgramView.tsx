      ...
      {currentLesson.id === 6 ? (
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/90 shadow-md">
            ...
            <div className="mt-6 p-4 sm:p-5 rounded-2xl bg-[#F5FFF9] border border-[#16A34A]/20 text-xs sm:text-sm text-slate-700 leading-relaxed">
              <strong className="text-[#075985] block mb-1">Executive Summary:</strong>
              {currentLesson.summary}
            </div>

            {/* Core Lesson Curriculum Sections */}
